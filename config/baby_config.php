...
define('BASEPATH'   , IS_LOCAL ? '/babyFramework/' : '____EL BASEPATH EN PRODUCCIÓN___');

// Sal del sistema
define('AUTH_SALT'  , 'BabyFramework<3');

// Puerto y la URL del sitio
//define('PORT'       , '7879');
//define('URL' '/BabyFramework/');
// define('URL'        , IS_LOCAL ? 'http://127.0.0.1:'.PORT.'/BabyFramework/' : '___URL EN PRODUCCIÓN___');
...
//Vista base de todo el proyecto, a partir de ésta se solicita el body necesario
define('BASEVIEWS'  , RESOURCES.'views/base/basePage.php');
...
define('LDB_NAME'   , 'BabyFramworkTest');
